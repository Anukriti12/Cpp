...
//		void modifyStudentDept(Student&s, string dept);
		...
		//friend void addBonus(Employee&e ,Student&s , long bonus );
		 void addBonus(Employee& , long bonus );
		 void modifySalary(Employee&, Student&, long);
...
class Student{
	...
	public:
		...
		//class Employee;
         ...
         friend void addBonus(Employee& , long bonus );
...
////		friend void addBonus(Employee&e, Student&s ,long bonus );
	...
	void  modifySalary(Employee&e, Student&s, long amt){
...
long bonus;
cout<<"Add Bonus to the employee: ";
cin>>bonus;
addBonus(e,bonus);
e.display();

cout<<"\n Enter Amount to transfer from employee to student: ";
cin>>bonus;
modifySalary(e,s,bonus);
