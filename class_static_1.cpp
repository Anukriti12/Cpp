...
void display();
 ...
 string Student::time = "Day Scholar";   // we need to define the static member outside the class
...
char g;
    ...
    Student s5("Ayush Aggarwal", "SOE","DTU/2K17/IT/33", 30, "1234567890");
     ...
     cout<<"\n ************* Student 1 *****************";
    s1.display();
    cout<<"\n"<<s1.getName()<<" is a "<<Student::gettime()<<endl;

     cout<<"\n ************* Student 2 *****************";
    s2.display();
     cout<<"\n"<<s2.getName()<<" is a "<<Student::gettime()<<endl;

     cout<<"\n ************* Student 3 *****************";
   s3.display();
     cout<<"\n"<<s3.getName()<<" is a "<<Student::gettime()<<endl;

     cout<<"\n ************* Student 4 *****************";
    s4.display();
     cout<<"\n"<<s4.getName()<<" is a "<<Student::gettime()<<endl;

     cout<<"\n ************* Student 5 *****************";
    s5.display();
     cout<<"\n"<<s5.getName()<<" is a "<<Student::gettime()<<endl;
  ...
  /*  cout<<"\n Enter "<<s5.getName()<<"'s Grade: ";
    ...
    */
    ...
    cout<<"\n College gave free hostels to all students !!"<<endl;
    Student::settime("Hosteller");
     cout<<"\n "<<s1.getName()<<" is a "<<Student::gettime()<<" now"<<endl;
     cout<<"\n "<<s2.getName()<<" is a "<<Student::gettime()<<" now"<<endl;
     cout<<"\n "<<s3.getName()<<" is a "<<Student::gettime()<<" now"<<endl;
     cout<<"\n "<<s4.getName()<<" is a "<<Student::gettime()<<" now"<<endl;
     cout<<"\n "<<s5.getName()<<" is a "<<Student::gettime()<<" now"<<endl;
